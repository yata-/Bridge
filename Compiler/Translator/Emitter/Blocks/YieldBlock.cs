...
namespace Bridge.Translator
{
    public class YieldBlock : AbstractEmitterBlock
    {
        ...
        protected override void DoEmit()
        {
            ...
            {
                this.Write(Variables.YIELD + ".push");
        ...
        {
            block.Write("var " + Variables.YIELD + " = []");
        ...
        public static void EmitYieldReturn(AbstractEmitterBlock block, IType returnType)
        {
            ...
            {
                block.Write(Types.Array + "." + Functions.TO_ENUMERATOR + "(" + Variables.YIELD +")");
            }
            else
            {
                block.Write(Types.Array + "." + Functions.TO_ENUMERABLE + "(" + Variables.YIELD + ")");
            }
