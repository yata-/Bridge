    ...
    public partial class Translator
    {
        ...
        protected virtual string GetBuilderArguments()
        {
            switch (Environment.OSVersion.Platform)
            {
                ...
                case PlatformID.Unix:
                case PlatformID.MacOSX:
                    return String.Format(" \"{0}\" /t:Rebuild /p:Configuration={1} /p:Platform={2} {3}", Location, this.ProjectProperties.Configuration, this.ProjectProperties.Platform, this.BuildArguments);
