...
namespace Bridge.Translator.Tests
{
    ...
    internal class OutputTest
    {
        ...
        [TestCase("04", true, true, TestName = "OutputTest 04 - Bridge.json outputBy Class ignoreCast true")]
        [TestCase("05", true, true, TestName = "OutputTest 05 - Bridge.json outputBy Namespace ignoreCast default")]
