...
Bridge.initAssembly("Bridge.ClientTest.Batch3", function ($asm, globals) {
                        ...
                        for (;;) {
                            ...
                            switch ($step) {
                                case 0: {
                                    ...
                                    $task2 = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1189.fooLong();
                                    $step = 1;
                                    $task2.continueWith($asyncBody, true);
                                    return;
                                }
                                case 1: {
                                    ...
                                    $task1 = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1189.fooDecimal();
                                    $step = 2;
                                    $task1.continueWith($asyncBody, true);
                                    return;
                                }
    ...
    Bridge.apply($_.Bridge.ClientTest.Batch3.BridgeIssues.Bridge1217, {
        f1: function () {
            return Bridge.cast(null, Bridge.ClientTest.Batch3.BridgeIssues.Bridge1217.DemoNavigator);
        }
    });
                        ...
                        for (;;) {
                            ...
                            switch ($step) {
                                case 0: {
                                    ...
                                    $task2 = Bridge.ClientTest.Batch3.BridgeIssues.Bridge830.testMethod("", false);
                                    $step = 1;
                                    $task2.continueWith($asyncBody, true);
                                    return;
                                }
                                case 1: {
                                    ...
                                    $task1 = Bridge.ClientTest.Batch3.BridgeIssues.Bridge830.testMethod("", true);
                                    $step = 2;
                                    $task1.continueWith($asyncBody, true);
                                    return;
                                }
