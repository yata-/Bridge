Bridge.initAssembly("test", function ($asm, globals) {
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner', {
        statics: {
            ...
            main: function () {
                ...
                QUnit.test("#1467 - TestHtmlElements", Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge1467.testHtmlElements);
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge1467', {
        ...
        statics: {
            testHtmlElements: function (assert) {
                var t = Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1467).beforeTest(false, assert, Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge1467);
                Bridge.ClientTest.Batch3.BridgeIssues.Bridge1467.testHtmlElements();
            }
        }
    });
