Bridge.initAssembly("test", function ($asm, globals) {
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner', {
        statics: {
            ...
            main: function () {
                ...
                QUnit.test("#1702 - TestPropertyNameOnNestedClassWithinGenericClass", Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge1702.testPropertyNameOnNestedClassWithinGenericClass);
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge1702', {
        ...
        statics: {
            testPropertyNameOnNestedClassWithinGenericClass: function (assert) {
                var t = Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1702).beforeTest(true, assert, Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge1702);
                t.getFixture().testPropertyNameOnNestedClassWithinGenericClass();
            }
        }
    });
