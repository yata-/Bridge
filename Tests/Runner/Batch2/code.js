(function (globals) {
    ...
    Bridge.define('Bridge.ClientTestOne.BridgeIssues.N772', {
        ...
        containsUsesEqualsMethod: function () {
            ...
            Bridge.Test.Assert.$true(Bridge.Linq.Enumerable.from(arr).contains(new Bridge.ClientTestOne.BridgeIssues.N772.C(2)));
            Bridge.Test.Assert.$false(Bridge.Linq.Enumerable.from(arr).contains(new Bridge.ClientTestOne.BridgeIssues.N772.C(4)));
        },
        allWithArrayItemFilterCallbackWorks: function () {
            Bridge.Test.Assert.$true(Bridge.Linq.Enumerable.from([1, 2, 3]).all($_.Bridge.ClientTestOne.BridgeIssues.N772.f1));
            Bridge.Test.Assert.$false(Bridge.Linq.Enumerable.from([1, 2, 3]).all($_.Bridge.ClientTestOne.BridgeIssues.N772.f2));
        },
        ...
        indexOfWithoutStartIndexUsesEqualsMethod: function () {
            var arr = [new Bridge.ClientTestOne.BridgeIssues.N772.C(1), new Bridge.ClientTestOne.BridgeIssues.N772.C(2), new Bridge.ClientTestOne.BridgeIssues.N772.C(3)];
            Bridge.Test.Assert.areEqual(1, Bridge.Linq.Enumerable.from(arr).indexOf(new Bridge.ClientTestOne.BridgeIssues.N772.C(2)));
            Bridge.Test.Assert.areEqual(-1, Bridge.Linq.Enumerable.from(arr).indexOf(new Bridge.ClientTestOne.BridgeIssues.N772.C(4)));
        },
        ...
        anyWithArrayItemFilterCallbackWorks: function () {
            Bridge.Test.Assert.$true(Bridge.Linq.Enumerable.from([1, 2, 3, 4]).any($_.Bridge.ClientTestOne.BridgeIssues.N772.f3));
            Bridge.Test.Assert.$false(Bridge.Linq.Enumerable.from([1, 2, 3, 4]).any($_.Bridge.ClientTestOne.BridgeIssues.N772.f4));
        },
        ...
        binarySearch3Works: function () {
            ...
            Bridge.Test.Assert.areEqual(2, Bridge.Array.binarySearch(arr, 0, arr.length, 3, new Bridge.ClientTestOne.BridgeIssues.N772.TestReverseComparer()));
            Bridge.Test.Assert.areEqual(-1, Bridge.Array.binarySearch(arr, 0, arr.length, 6, new Bridge.ClientTestOne.BridgeIssues.N772.TestReverseComparer()));
        },
        binarySearch4Works: function () {
            var arr = [1, 2, 3, 3, 4, 5];
    
            Bridge.Test.Assert.areEqual(3, Bridge.Array.binarySearch(arr, 3, 2, 3, new Bridge.ClientTestOne.BridgeIssues.N772.TestReverseComparer()));
            Bridge.Test.Assert.$true(Bridge.Array.binarySearch(arr, 3, 2, 4, new Bridge.ClientTestOne.BridgeIssues.N772.TestReverseComparer()) < 0);
        },
        ...
        iCollectionClearWorks: function () {
            ...
            Bridge.Test.Assert.areDeepEqual(Bridge.Array.init(0, null), l);
        },
        ...
        iCollectionContainsUsesEqualsMethod: function () {
            ...
            Bridge.Test.Assert.$true(Bridge.Array.contains(l, new Bridge.ClientTestOne.BridgeIssues.N772.C(2)));
            Bridge.Test.Assert.$false(Bridge.Array.contains(l, new Bridge.ClientTestOne.BridgeIssues.N772.C(4)));
        },
