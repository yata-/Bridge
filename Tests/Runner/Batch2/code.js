(function (globals) {
    ...
    Bridge.define('Bridge.ClientTest.Batch2.CheckedUncheckedTests.UncheckedInsideCheckedTests', {
        statics: {
            testInt32: function () {
                var max = 2147483647;
                var rMax = Bridge.Int.check(max + 1, Bridge.Int32);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-2147483648", rMax, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-2147483648", max + 1, "Through parameter");
    
                var min = -2147483648;
                var rMin = Bridge.Int.check(min - 1, Bridge.Int32);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("2147483647", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("2147483647", min - 1, "Through parameter");
            },
            testUInt32: function () {
    
                var max = 4294967295;
                var rMax = Bridge.Int.check(max + 1, Bridge.UInt32);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("0", rMax, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("0", max + 1, "Through parameter");
    
                var min = 0;
                var rMin = Bridge.Int.check(min - 1, Bridge.UInt32);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("4294967295", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("4294967295", min - 1, "Through parameter");
            },
            testLong: function () {
                var max = Bridge.Long.MaxValue;
                var rMax = max.add(Bridge.Long(1), 1);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-9223372036854775808", rMax, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-9223372036854775808", max.add(Bridge.Long(1), 1), "Through parameter");
    
                var min = Bridge.Long.MinValue;
                var rMin = min.sub(Bridge.Long(1), 1);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("9223372036854775807", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("9223372036854775807", min.sub(Bridge.Long(1), 1), "Through parameter");
            },
            testULong: function () {
                var max = Bridge.ULong.MaxValue;
                var rMax = max.add(Bridge.ULong(1), 1);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("0", rMax, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("0", max.add(Bridge.ULong(1), 1), "Through parameter");
    
                var min = Bridge.ULong.MinValue;
                var rMin = min.sub(Bridge.ULong(1), 1);
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("18446744073709551615", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("18446744073709551615", min.sub(Bridge.ULong(1), 1), "Through parameter");
            }
        }
    });
    ...
    Bridge.define('Bridge.ClientTest.Batch2.CheckedUncheckedTests.UncheckedTests', {
        statics: {
            ...
            testLong: function () {
                ...
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-9223372036854775808", rMax, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-9223372036854775808", max.add(Bridge.Long(1)), "Through parameter");
    
                var min = Bridge.Long.MinValue;
                var rMin = min.sub(Bridge.Long(1));
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("9223372036854775807", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("9223372036854775807", min.sub(Bridge.Long(1)), "Through parameter");
            },
            testULong: function () {
                var max = Bridge.ULong.MaxValue;
                var rMax = max.add(Bridge.ULong(1));
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("0", rMax, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("0", max.add(Bridge.ULong(1)), "Through parameter");
    
                var min = Bridge.ULong.MinValue;
                var rMin = min.sub(Bridge.ULong(1));
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("18446744073709551615", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("18446744073709551615", min.sub(Bridge.ULong(1)), "Through parameter");
            }
        }
    });
    ...
    Bridge.define('Bridge.ClientTest.Batch2.CheckedUncheckedTests.WithNoUncheckedKeywordTests', {
        statics: {
            testInt32: function () {
                ...
                var min = -2147483648;
                var rMin = min - 1;
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-2147483649", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-2147483649", min - 1, "Through parameter");
            },
            testUInt32: function () {
                var max = 4294967295;
                var rMax = max + 1;
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("4294967296", rMax, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("4294967296", max + 1, "Through parameter");
    
                var min = 0;
                var rMin = min - 1;
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-1", rMin, "Through identifier");
                Bridge.get(Bridge.ClientTest.Batch2.CheckedUncheckedTests).assertEqual("-1", min - 1, "Through parameter");
            },
            testLong: function () {
                var max = Bridge.Long.MaxValue;
                var rMax = max.add(Bridge.Long(1));
