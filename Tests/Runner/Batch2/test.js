(function (globals) {
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner', {
        statics: {
            ...
            runTests: function () {
                QUnit.module("Issues");
                QUnit.test("#772 clientOne - TypePropertiesAreCorrect", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.typePropertiesAreCorrect);
                QUnit.test("#772 clientOne - LengthWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.lengthWorks);
                QUnit.test("#772 clientOne - RankIsOne", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.rankIsOne);
                QUnit.test("#772 clientOne - GetLengthWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.getLengthWorks);
                QUnit.test("#772 clientOne - GetLowerBound", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.getLowerBound);
                QUnit.test("#772 clientOne - GetUpperBoundWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.getUpperBoundWorks);
                QUnit.test("#772 clientOne - GettingValueByIndexWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.gettingValueByIndexWorks);
                QUnit.test("#772 clientOne - GetValueWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.getValueWorks);
                QUnit.test("#772 clientOne - SettingValueByIndexWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.settingValueByIndexWorks);
                QUnit.test("#772 clientOne - SetValueWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.setValueWorks);
                QUnit.test("#772 clientOne - ForeachWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.foreachWorks);
                QUnit.test("#772 clientOne - CloneWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.cloneWorks);
                QUnit.test("#772 clientOne - ConcatWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.concatWorks);
                QUnit.test("#772 clientOne - ContainsWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.containsWorks);
                QUnit.test("#772 clientOne - ContainsUsesEqualsMethod", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.containsUsesEqualsMethod);
                QUnit.test("#772 clientOne - AllWithArrayItemFilterCallbackWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.allWithArrayItemFilterCallbackWorks);
                QUnit.test("#772 clientOne - SliceWithoutEndWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.sliceWithoutEndWorks);
                QUnit.test("#772 clientOne - ForeachWithArrayItemCallbackWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.foreachWithArrayItemCallbackWorks);
                QUnit.test("#772 clientOne - ForeachWithArrayCallbackWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.foreachWithArrayCallbackWorks);
                QUnit.test("#772 clientOne - IndexOfWithoutStartIndexWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.indexOfWithoutStartIndexWorks);
                QUnit.test("#772 clientOne - IndexOfWithoutStartIndexUsesEqualsMethod", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.indexOfWithoutStartIndexUsesEqualsMethod);
                QUnit.test("#772 clientOne - IndexOfWithStartIndexWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.indexOfWithStartIndexWorks);
                QUnit.test("#772 clientOne - JoinWithoutDelimiterWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.joinWithoutDelimiterWorks);
                QUnit.test("#772 clientOne - ReverseWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.reverseWorks);
                QUnit.test("#772 clientOne - AnyWithArrayItemFilterCallbackWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.anyWithArrayItemFilterCallbackWorks);
                QUnit.test("#772 clientOne - BinarySearch1Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.binarySearch1Works);
                QUnit.test("#772 clientOne - BinarySearch2Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.binarySearch2Works);
                QUnit.test("#772 clientOne - BinarySearch3Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.binarySearch3Works);
                QUnit.test("#772 clientOne - BinarySearch4Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.binarySearch4Works);
                QUnit.test("#772 clientOne - BinarySearchExceptionsWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.binarySearchExceptionsWorks);
                QUnit.test("#772 clientOne - SortWithDefaultCompareWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.sortWithDefaultCompareWorks);
                QUnit.test("#772 clientOne - Sort1Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.sort1Works);
                QUnit.test("#772 clientOne - Sort2Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.sort2Works);
                QUnit.test("#772 clientOne - Sort3Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.sort3Works);
                QUnit.test("#772 clientOne - Sort4Works", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.sort4Works);
                QUnit.test("#772 clientOne - SortExceptionsWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.sortExceptionsWorks);
                QUnit.test("#772 clientOne - ForeachWhenCastToIListWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.foreachWhenCastToIListWorks);
                QUnit.test("#772 clientOne - ICollectionCountWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iCollectionCountWorks);
                QUnit.test("#772 clientOne - ICollectionAddWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iCollectionAddWorks);
                QUnit.test("#772 clientOne - ICollectionClearWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iCollectionClearWorks);
                QUnit.test("#772 clientOne - ICollectionContainsWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iCollectionContainsWorks);
                QUnit.test("#772 clientOne - ICollectionContainsUsesEqualsMethod", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iCollectionContainsUsesEqualsMethod);
                QUnit.test("#772 clientOne - ICollectionRemoveWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iCollectionRemoveWorks);
                QUnit.test("#772 clientOne - IListIndexingWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iListIndexingWorks);
                QUnit.test("#772 clientOne - IListIndexOfWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iListIndexOfWorks);
                QUnit.test("#772 clientOne - IListIndexOfUsesEqualsMethod", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iListIndexOfUsesEqualsMethod);
                QUnit.test("#772 clientOne - IListInsertWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iListInsertWorks);
                QUnit.test("#772 clientOne - IListRemoveAtWorks", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.iListRemoveAtWorks);
                QUnit.test("#772 clientOne - IssueSpecific", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.issueSpecific);
                QUnit.test("#772 clientOne - TestUseCase", Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772.testUseCase);
            }
        }
    });
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772', {
        ...
        statics: {
            typePropertiesAreCorrect: function (assert) {
                var t = Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTestOne.BridgeIssues.N772).beforeTest(true, assert, Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772);
            ...
            testUseCase: function (assert) {
                var t = Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTestOne.BridgeIssues.N772).beforeTest(false, assert, Bridge.Test.QUnit.TestRunner.Bridge_ClientTestOne_BridgeIssues_N772, 10);
                Bridge.ClientTestOne.BridgeIssues.N772.testUseCase();
            }
        }
    });
