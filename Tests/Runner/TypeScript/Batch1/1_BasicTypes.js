...
QUnit.test("Issue #1898", function (assert) {
    ...
    assert.throws(function () {
        return new System.Guid.$ctor1([0x78, 0x95, 0x62, 0xa8, 0x26, 0x7a]);
    }, "Invalid array should throw");
    ...
    assert.equal(g4.toString(), "a6993c0a-a8cb-45d9-994b-90e7203e4fc6", "g4");
    assert.throws(function () {
        return System.Guid.parseExact("A6993C0A-A8CB-45D9-994B-90E7203E4FC6", "B");
    }, "Invalid B should throw");
    assert.throws(function () {
        return System.Guid.parseExact("A6993C0A-A8CB-45D9-994B-90E7203E4FC6", "P");
    }, "Invalid P should throw");
    assert.throws(function () {
        return System.Guid.parseExact("A6993C0A-A8CB-45D9-994B-90E7203E4FC6", "N");
    }, "Invalid N should throw");
    assert.throws(function () {
        return System.Guid.parseExact("A6993C0AA8CB45D9994B90E7203E4FC6", "D");
    }, "Invalid D should throw");
