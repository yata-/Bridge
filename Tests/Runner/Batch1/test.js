    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner', {
        statics: {
            ...
            runTests: function () {
                ...
                QUnit.test("#1051 - TestInlinePopertyWithValue", Bridge.get(Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1051).testInlinePopertyWithValue);
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1051', {
        ...
        statics: {
            testInlinePopertyWithValue: function (assert) {
                var t = Bridge.get(Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.BridgeIssues.Bridge1051)).beforeTest(false, assert, Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1051);
                Bridge.get(Bridge.ClientTest.BridgeIssues.Bridge1051).testInlinePopertyWithValue();
            }
        }
    });
