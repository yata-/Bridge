    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner', {
        statics: {
            ...
            runTests: function () {
                ...
                QUnit.test("#999_1 - TestNestedLambdasToLiftingInForeach", Bridge.get(Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge999_1).testNestedLambdasToLiftingInForeach);
