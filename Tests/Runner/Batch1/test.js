(function (globals) {
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner', {
        statics: {
            ...
            runTests: function () {
                ...
                QUnit.test("#1103 - TestPropertyOps", Bridge.get(Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1103).testPropertyOps);
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1103', {
        ...
        statics: {
            testPropertyOps: function (assert) {
                var t = Bridge.get(Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.BridgeIssues.Bridge1103)).beforeTest(false, assert, Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1103);
                Bridge.get(Bridge.ClientTest.BridgeIssues.Bridge1103).testPropertyOps();
            }
        }
    });
