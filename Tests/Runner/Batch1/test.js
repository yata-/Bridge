(function (globals) {
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner', {
        statics: {
            ...
            runTests: function () {
                ...
                QUnit.test("#1098 - TestInlineConstantAsMemberReference", Bridge.get(Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1098).testInlineConstantAsMemberReference);
    ...
    Bridge.define('Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1098', {
        ...
        statics: {
            testInlineConstantAsMemberReference: function (assert) {
                var t = Bridge.get(Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.BridgeIssues.Bridge1098)).beforeTest(false, assert, Bridge.Test.QUnit.TestRunner.Bridge_ClientTest_BridgeIssues_Bridge1098);
                Bridge.get(Bridge.ClientTest.BridgeIssues.Bridge1098).testInlineConstantAsMemberReference();
            }
        }
    });
