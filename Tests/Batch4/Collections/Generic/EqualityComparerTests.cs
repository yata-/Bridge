...
{
    [TestFixture(TestNameFormat = "EqualityComparerTests - {0}")]
    public class EqualityComparerTests
    {
        ...
        public void DefaultComparerCanDetermineEquality()
        {
            ...
            Assert.True(EqualityComparer<object>.Default.Equals(null, null));
            Assert.False(EqualityComparer<object>.Default.Equals(null, o1));
            Assert.False(EqualityComparer<object>.Default.Equals(o1, null));
            Assert.True(EqualityComparer<object>.Default.Equals(o1, o1));
            Assert.False(EqualityComparer<object>.Default.Equals(o1, o2));
        }
