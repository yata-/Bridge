...
{
    [TestFixture(TestNameFormat = "DateTimeFormatInfoTests - {0}")]
    public class DateTimeFormatInfoTests
    {
        ...
        public void TypePropertiesAreCorrect()
        {
            ...
            Assert.AreEqual(new[] { typeof(IFormatProvider), typeof(ICloneable) }, typeof(DateTimeFormatInfo).GetInterfaces());
