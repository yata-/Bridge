...
{
    [TestFixture(TestNameFormat = "ObjectTests - {0}")]
    public class ObjectTests
    {
        ...
        public void ReferenceEqualsWorks()
        {
            ...
            Assert.True(ReferenceEquals(n, n));
            Assert.True(ReferenceEquals(n, Script.Undefined));
            Assert.False(ReferenceEquals(o1, o2));
            Assert.False(ReferenceEquals(o1, n));
            Assert.False(ReferenceEquals(o1, Script.Undefined));
            Assert.True(ReferenceEquals(o1, o1));
        }
