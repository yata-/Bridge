...
namespace Bridge.ClientTest.Batch4.SimpleTypes
{
    ...
    public class DecimalTests
    {
        ...
        private void AssertIsDecimalAndEqualTo(object v, string s)
        {
            Assert.True(v is decimal);
            Assert.AreStrictEqual(s, v.ToString());
        }
        ...
        {
            Assert.AreEqual("291", ((IFormattable)291m).Format("", CultureInfo.InvariantCulture));
        }
        ...
        {
            Assert.AreEqual("123", ((Object)123m).ToString());
        }
        ...
        public void DecimalToULong_SPI_1584_1585()
        {
            ...
            ulong u1 = 0;
            TestHelper.Safe(() => u1 = (ulong)(x - 0.9m));
            Assert.AreEqual(0UL, u1);

            ulong u2 = 0;
            TestHelper.Safe(() => u2 = (ulong)(x + 42949672950.9m));
        ...
        public void NullableDecimalToFloat_SPI_1579()
        {
            ...
            float? f1 = null;
            TestHelper.Safe(() => f1 = (float?)(x1 + 10.5m));
            Assert.AreEqual(10.5, f1);
            // #1579
            // Test restructure to keep assertion count correct (prevent uncaught test exception)
            float f2 = 0;
            TestHelper.Safe(() => f2 = (float)(x1 + 10.5m));
            Assert.AreEqual(10.5, f2);

            float? f3 = null;
            TestHelper.Safe(() => f3 = (float?)x2);
        ...
        public void NullableDecimalToDouble_SPI_1579()
        {
            ...
            // Test restructure to keep assertion count correct(prevent uncaught test exception)
            double d1 = 0;
            TestHelper.Safe(() => d1 = (double)(x1 + 10.5m));
            Assert.AreEqual(10.5, d1);

            double? d2 = null;
            TestHelper.Safe(() => d2 = (double?)x2);
...
#pragma warning restore 464
        ...
        public void RoundWorks()
        {
            ...
            AssertIsDecimalAndEqualTo(decimal.Round(4.5m), 4);
        }

        [Test]
        public void RoundWithDecimalsWorks()
        {
            AssertIsDecimalAndEqualTo(decimal.Round(3.2209m, 2), 3.22);
            AssertIsDecimalAndEqualTo(decimal.Round(.2209m, 2), .22);
            AssertIsDecimalAndEqualTo(decimal.Round(3.225m, 2), 3.22);
        }

        [Test]
        public void RoundWithMidpointRoundingWorks()
        {
            AssertIsDecimalAndEqualTo(decimal.Round(4.5m, MidpointRounding.AwayFromZero), 5);
            AssertIsDecimalAndEqualTo(decimal.Round(-4.5m, MidpointRounding.AwayFromZero), -5);
            AssertIsDecimalAndEqualTo(decimal.Round(4.5m, MidpointRounding.ToEven), 4);
            AssertIsDecimalAndEqualTo(decimal.Round(-4.5m, MidpointRounding.ToEven), -4);
        }

        [Test]
        public void RoundWithDecimalsAndMidpointRoundingWorks()
        {
            AssertIsDecimalAndEqualTo(decimal.Round(4.225m, 2, MidpointRounding.AwayFromZero), 4.23);
            AssertIsDecimalAndEqualTo(decimal.Round(-4.225m, 2, MidpointRounding.AwayFromZero), -4.23);
            AssertIsDecimalAndEqualTo(decimal.Round(4.2249m, 2, MidpointRounding.AwayFromZero), 4.22);
            AssertIsDecimalAndEqualTo(decimal.Round(-4.2249m, 2, MidpointRounding.AwayFromZero), -4.22);
            AssertIsDecimalAndEqualTo(decimal.Round(4.225m, 2, MidpointRounding.ToEven), 4.22);
            AssertIsDecimalAndEqualTo(decimal.Round(-4.225m, 2, MidpointRounding.ToEven), -4.22);
            AssertIsDecimalAndEqualTo(decimal.Round(4.2251m, 2, MidpointRounding.ToEven), 4.23);
            AssertIsDecimalAndEqualTo(decimal.Round(-4.2251m, 2, MidpointRounding.ToEven), -4.23);
        }
        ...
        {
            Assert.True(decimal.Equals(0, 0));
            Assert.False(decimal.Equals(1, 0));
            Assert.False(decimal.Equals(0, 0.5));
            Assert.True(decimal.Equals(1, 1));
        }
