...
{
    [TestFixture(TestNameFormat = "AttributeTests - {0}")]
    public class AttributeTests
    {
        ...
        public void CanGetCustomTypeAttributesForTypeWithNoAttributes()
        {
            ...
            Assert.AreEqual(0, arr.Length, "Should have no attributes");
        }
        ...
        public void CanGetCustomTypeAttributesForClassWithAttributes()
        {
            ...
            Assert.AreEqual(2, arr.Length, "Should have two attributes");
        ...
        public void NonScriptableAttributesAreNotIncluded()
        {
            ...
            Assert.AreEqual(1, arr.Length, "Should have one attribute");
        ...
        public void InheritedFlagToGetCustomAttributesWorks()
        {
            ...
            Assert.AreEqual(1, arr.Length, "Should have one non-inherited attribute");
            Assert.True(arr[0] is A3Attribute);

            arr = typeof(C3).GetCustomAttributes(true);
            Assert.AreEqual(3, arr.Length, "Should have three inherited attributes");
        ...
        public void DeepInheritanceWorks()
        {
            ...
            Assert.AreEqual(4, arr.Length, "Should have 4 attributes");
        ...
        public void OverridingSingleUseAttributeReplacesTheAttributeOnTheBaseClass()
        {
            ...
            Assert.AreEqual(2, arr.Length, "Should have 2 attributes");
            Assert.True(arr[0] is A1Attribute || arr[1] is A1Attribute, "A1 should exist");
            Assert.True(arr[0] is A2Attribute || arr[1] is A2Attribute, "A2 should exist");
            var a1 = (A1Attribute)(arr[0] is A1Attribute ? arr[0] : arr[1]);
            Assert.AreEqual(5, a1.V);
        }
        ...
        public void ApplyingNewInstanceOfMultipleUseAttributeAddsTheAttribute()
        {
            ...
            Assert.AreEqual(3, arr.Length, "Should have 2 attributes");
            Assert.AreEqual(arr.Filter(a => a is A1Attribute).Length, 1, "Should have one A1");
        ...
        public void NonInheritedAttributeIsNotInherited()
        {
            ...
            Assert.AreEqual(0, arr.Length, "Should not have any attributes");
        }
        ...
        public void GetCustomAttributesTypeFilterWorks()
        {
            ...
            Assert.AreEqual(2, arr.Length, "Should have 2 A2 attributes");
        ...
        public void AllSupportedScalarTypesCanBeUsedAsAttributeArguments()
        {
            ...
            Assert.AreEqual(true, a6.B, "B");
            Assert.AreEqual(43, a6.Y, "Y");
            Assert.AreEqual(0x44, (int)a6.C, "C");
            Assert.AreEqual(45.5, a6.D, "D");
            Assert.AreEqual(46.5, a6.F, "F");
            Assert.AreEqual(47, a6.I, "I");
            Assert.True(a6.L == 48, "L");
            Assert.AreEqual(49, a6.H, "H");
            Assert.AreEqual(E1.V1, a6.E, "E");
            Assert.AreEqual("Test_string", a6.S, "S");
            Assert.AreEqual(null, a6.O, "O");
            Assert.AreEqual(typeof(string), a6.T, "T");
        }
        ...
        public void ArraysCanBeUsedAsAttributeArguments()
        {
            ...
            Assert.AreEqual(new[] { 42, 17, 31 }, a7.I, "I");
            Assert.AreEqual(new[] { "X", "Y2", "Z3" }, a7.S, "S");
        }
        ...
        public void CreatingAttributeWithInlineCodeConstructorWorks()
        {
            ...
            Assert.AreEqual(18, a.i);
        }

        [Test]
        public void ConditionalAttributesWhoseSymbolsAreNotDefinedAreRemoved()
        {
            Assert.AreEqual(1, typeof(C22).GetCustomAttributes(typeof(A12Attribute), false).Length, "A12");
            Assert.AreEqual(1, typeof(C22).GetCustomAttributes(typeof(A13Attribute), false).Length, "A13");
            Assert.AreEqual(0, typeof(C22).GetCustomAttributes(typeof(A14Attribute), false).Length, "A14");
            Assert.AreEqual(1, typeof(C22).GetMethod("M").GetCustomAttributes(typeof(A12Attribute), false).Length, "A12");
            Assert.AreEqual(1, typeof(C22).GetMethod("M").GetCustomAttributes(typeof(A13Attribute), false).Length, "A13");
            Assert.AreEqual(0, typeof(C22).GetMethod("M").GetCustomAttributes(typeof(A14Attribute), false).Length, "A14");
        }
    }
}
