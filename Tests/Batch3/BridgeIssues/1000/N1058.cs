...
namespace Bridge.ClientTest.Batch3.BridgeIssues
{
    ...
    public class Bridge1058
    {
        ...
        {
            Assert.AreEqual("Bridge.ClientTest.Batch3.BridgeIssues.Bridge1058.overlayType", typeof(OverlayType).GetClassName());
        ...
        {
            Assert.AreEqual("Bridge.ClientTest.Batch3.BridgeIssues.Bridge1058.OverlayType_B", typeof(OverlayType_B).GetClassName());
