...
namespace Bridge.ClientTest.Batch3.BridgeIssues
{
    ...
    public class Bridge1256
    {
        ...
        static void TestFields(object o)
        {
            if (o == null)
            {
        ...
        static void TestMethods(object o)
        {
            if (o == null)
            {
                Assert.Fail("Object cannot be null");
...
#pragma warning disable 414 //CS0414  The field 'Bridge1256.ReservedProperties.Case' is assigned but its value is never used
        ...
        {
            private int Abstract() { return 1; }
            private int Arguments() { return 2; }
            private int As() { return 3; }
            private int Boolean() { return 4; }
            private int Break() { return 5; }
            private int Byte() { return 6; }
            private int Case() { return 7; }
            private int Catch() { return 8; }
            private int Char() { return 9; }
            private int Class() { return 10; }
            private int Continue() { return 11; }
            private int Const() { return 12; }
            private int constructor() { return 13; }
            private int Debugger() { return 14; }
            private int Default() { return 15; }
            private int Delete() { return 16; }
            private int Do() { return 17; }
            private int Double() { return 18; }
            private int Else() { return 19; }
            private int Enum() { return 20; }
            private int Eval() { return 21; }
            private int Export() { return 22; }
            private int Extends() { return 23; }
            private int False() { return 24; }
            private int Final() { return 25; }
            private int Finally() { return 26; }
            private int Float() { return 27; }
            private int For() { return 28; }
            private int Function() { return 29; }
            private int Goto() { return 30; }
            private int If() { return 31; }
            private int Implements() { return 32; }
            private int Import() { return 33; }
            private int In() { return 34; }
            private int Instanceof() { return 35; }
            private int Int() { return 36; }
            private int Interface() { return 37; }
            private int Let() { return 38; }
            private int Long() { return 39; }
            private int Namespace() { return 40; }
            private int Native() { return 41; }
            private int New() { return 42; }
            private int Null() { return 43; }
            private int Package() { return 44; }
            private int Private() { return 45; }
            private int Protected() { return 46; }
            private int Public() { return 47; }
            private int Return() { return 48; }
            private int Short() { return 49; }
            private int Static() { return 50; }
            private int Super() { return 51; }
            private int Switch() { return 52; }
            private int Synchronized() { return 53; }
            private int This() { return 54; }
            private int Throw() { return 55; }
            private int Throws() { return 56; }
            private int Transient() { return 57; }
            private int True() { return 58; }
            private int Try() { return 59; }
            private int Typeof() { return 60; }
            private int Use() { return 61; }
        ...
        private static int Let() { return 5; }
