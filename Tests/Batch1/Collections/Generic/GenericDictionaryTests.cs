...
namespace Bridge.ClientTest.Collections.Generic
{
    ...
    public class GenericDictionaryTests
    {
        ...
        {
            Assert.AreEqual("System.Collections.Generic.Dictionary$2[[System.Int32, System],[String]]", typeof(Dictionary<int, string>).GetClassName(), "FullName should be correct");
