...
#pragma warning disable 649, 108, 67, 169
		class B1 {
			[A1(101)] public B1() {}
			[A1(102)] public B1(int x) {}
			[A1(103)] public B1(int x, string y) {}

			[A1(111)] public void MB() {}
			[A1(112)] public void MB(int x) {}
			[A1(113)] public void MB(int x, string y) {}
			[A1(114)] public void MB2(int x, string y) {}

			[A1(121)] public static void MBS() {}
			[A1(122)] public static void MBS(int x) {}
			[A1(123)] public static void MBS(int x, string y) {}
			[A1(124)] public static void MBS2(int x, string y) {}

			[A1(131)] public int FB1;
			[A1(132)] public int FB2;

			[A1(141)] public static int FBS1;
			[A1(142)] public static int FBS2;

			[A1(151)] public int PB1 { [A1(152)] get; [A1(153)] set; }
			[A1(154)] public int PB2 { [A1(155)] get; [A1(156)] set; }
			[A1(157)] public int this[int x] { [A1(158)] get { return 0; } [A1(159)] set {} }

			[A1(161)] public static int PBS1 { [A1(162)] get; [A1(163)] set; }
			[A1(164)] public static int PBS2 { [A1(165)] get; [A1(166)] set; }

			[A1(171)] public event Action EB1 { [A1(172)] add {} [A1(173)] remove {} }
			[A1(174)] public event Action EB2 { [A1(175)] add {} [A1(176)] remove {} }

			[A1(181)] public static event Action EBS1 { [A1(182)] add {} [A1(183)] remove {} }
			[A1(184)] public static event Action EBS2 { [A1(185)] add {} [A1(186)] remove {} }
		}

#pragma warning disable CS0114 // Member hides inherited member; missing override keyword
        class C1 : B1 {
			[A1(201)] public C1() {}
			[A1(202)] public C1(int x) {}
			[A1(203)] public C1(int x, string y) {}

			[A1(211)] public void MC() {}
			[A1(212)] public void MC(int x) {}
			[A1(213)] public void MC(int x, string y) {}
			[A1(214)] public void MC2(int x, string y) {}

			[A1(221)] public static void MCS() {}
			[A1(222)] public static void MCS(int x) {}
			[A1(223)] public static void MCS(int x, string y) {}
			[A1(224)] public static void MCS2(int x, string y) {}

			[A1(231)] public int FC1;
			[A1(232)] public int FC2;

			[A1(241)] public static int FCS1;
			[A1(242)] public static int FCS2;

			[A1(251)] public int PC1 { [A1(252)] get; [A1(253)] set; }
			[A1(254)] public int PC2 { [A1(255)] get; [A1(256)] set; }

            [A1(257)] public int this[string x] { [A1(258)] get { return 0; } [A1(259)] set {} }

            [A1(261)] public static int PCS1 { [A1(262)] get; [A1(263)] set; }
			[A1(264)] public static int PCS2 { [A1(265)] get; [A1(266)] set; }

			[A1(271)] public event Action EC1 { [A1(272)] add {} [A1(273)] remove {} }
			[A1(274)] public event Action EC2 { [A1(275)] add {} [A1(276)] remove {} }

			[A1(281)] public static event Action ECS1 { [A1(282)] add {} [A1(283)] remove {} }
		...
		class D1 : C1, I1 {
			...
			[A1(311)] public void MD() {}
			[A1(312)] public void MD(int x) {}
			[A1(313)] public void MD(int x, string y) {}
			[A1(314)] public void MD2(int x, string y) {}

			[A1(321)] public static void MDS() {}
			[A1(322)] public static void MDS(int x) {}
			[A1(323)] public static void MDS(int x, string y) {}
			[A1(324)] public static void MDS2(int x, string y) {}

			[A1(331)] public int FD1;
			[A1(332)] public int FD2;

			[A1(341)] public static int FDS1;
			[A1(342)] public static int FDS2;

			[A1(351)] public int PD1 { [A1(352)] get; [A1(353)] set; }
			[A1(354)] public int PD2 { [A1(355)] get; [A1(356)] set; }
			[A1(357)] public int this[double x] { [A1(358)] get { return 0; } [A1(359)] set {} }

			[A1(361)] public static int PDS1 { [A1(362)] get; [A1(363)] set; }
			[A1(364)] public static int PDS2 { [A1(365)] get; [A1(366)] set; }

			[A1(371)] public event Action ED1 { [A1(372)] add {} [A1(373)] remove {} }
			[A1(374)] public event Action ED2 { [A1(375)] add {} [A1(376)] remove {} }
		...
		class B2 {
			[A1(111)] public void M() {}
			[A1(112)] public void MB() {}
			[A1(113)] public void M2(int x) {}
			[A1(114)] public void M2(string x) {}
			[A1(115)] public void M2B(int x) {}
			[A1(116)] public void M2B(string x) {}
			[A1(117)] public void M3(int x) {}

			[A1(121)] public static void MS() {}
			[A1(122)] public static void MBS() {}
			[A1(123)] public static void M2S(int x) {}
			[A1(124)] public static void M2S(string x) {}
			[A1(125)] public static void M2BS(int x) {}
			[A1(126)] public static void M2BS(string x) {}
			[A1(127)] public static void M3S(int x) {}

			[A1(131)] public int F;
			[A1(132)] public int FB;

			[A1(141)] public static int FS;
			[A1(142)] public static int FBS;

			[A1(151)] public int P { get; set; }
			[A1(152)] public int PB { get; set; }
			[A1(153)] public int this[int x] { get { return 0; } set {} }
			[A1(154)] public int this[string x] { get { return 0; } set {} }

			[A1(161)] public static int PS { get; set; }
			[A1(162)] public static int PBS { get; set; }

			[A1(171)] public event Action E;
			[A1(172)] public event Action EB;

			[A1(181)] public static event Action ES;
			[A1(182)] public static event Action EBS;
		}

		class C2 : B2 {
			[A1(211)] public void M() {}
			[A1(212)] public void MC() {}
			[A1(213)] public void M2(int x) {}
			[A1(214)] public void M2(string x) {}
			[A1(215)] public void M2C(int x) {}
			[A1(216)] public void M2C(string x) {}
			[A1(217)] public void M3(string x) {}

			[A1(221)] public static void MS() {}
			[A1(222)] public static void MCS() {}
			[A1(223)] public static void M2S(int x) {}
			[A1(224)] public static void M2S(string x) {}
			[A1(225)] public static void M2CS(int x) {}
			[A1(226)] public static void M2CS(string x) {}
			[A1(227)] public static void M3S(string x) {}

			[A1(231)] public int F;
			[A1(232)] public int FC;

			[A1(241)] public static int FS;
			[A1(242)] public static int FCS;

			[A1(251)] public int P { get; set; }
			[A1(252)] public int PC { get; set; }
			[A1(253)] public int this[int x] { get { return 0; } set {} }
			[A1(254)] public int this[double x] { get { return 0; } set {} }

			[A1(261)] public static int PS { get; set; }
			[A1(262)] public static int PCS { get; set; }

			[A1(271)] public event Action E;
			[A1(272)] public event Action EC;

			[A1(281)] public static event Action ES;
			[A1(282)] public static event Action ECS;
		}

		class D2 : C2 {
			[A1(311)] public void M() {}
			[A1(312)] public void MD() {}
			[A1(313)] public void M2(int x) {}
			[A1(314)] public void M2(string x) {}
			[A1(315)] public void M2D(int x) {}
			[A1(316)] public void M2D(string x) {}
			[A1(317)] public void M3(DateTime x) {}

			[A1(321)] public static void MS() {}
			[A1(322)] public static void MDS() {}
			[A1(323)] public static void M2S(int x) {}
			[A1(324)] public static void M2S(string x) {}
			[A1(325)] public static void M2DS(int x) {}
			[A1(326)] public static void M2DS(string x) {}
			[A1(327)] public static void M3S(DateTime x) {}

			[A1(331)] public int F;
			[A1(332)] public int FD;

			[A1(341)] public static int FS;
			[A1(342)] public static int FDS;

			[A1(351)] public int P { get; set; }
			[A1(352)] public int PD { get; set; }
			[A1(353)] public int this[int x] { get { return 0; } set {} }
			[A1(354)] public int this[DateTime x] { get { return 0; } set {} }

			[A1(361)] public static int PS { get; set; }
			[A1(362)] public static int PDS { get; set; }

			[A1(371)] public event Action E;
			[A1(372)] public event Action ED;

			[A1(381)] public static event Action ES;
			[A1(382)] public static event Action EDS;
		}
		...
		interface I1 {
			...
			[A1(457)] int this[int x] { [A1(458), Name("get_i1item")] get; [A1(459), Name("set_i1item")] set; }
		...
		interface I2 : I1 {
			...
			[A1(557)] int this[string x] { [A1(558), Name("get_item2")] get; [A1(559), Name("set_item2")] set; }
