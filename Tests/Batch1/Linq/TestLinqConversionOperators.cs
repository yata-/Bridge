...
namespace Bridge.ClientTest.Linq
{
    ...
    public class TestLinqConversionOperators
    {
        ...
        public static void Test()
        {
            ...
            Assert.AreEqual("System.Collections.Generic.List$1[[String]]", TypeHelper.GetTypeName(wordList1), "ToList() conversion with explicit String type for string - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.List$1[[String]]", TypeHelper.GetTypeName(wordList2), "ToList() conversion for string - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.Dictionary$2[[String],[Bridge.ClientTest.Utilities.Group, Bridge.ClientTest]]", TypeHelper.GetTypeName(groupDictionary1), "ToDictionary(keySelector, elementSelector) conversion for <string, Group> - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.Dictionary$2[[String],[Bridge.ClientTest.Utilities.Group, Bridge.ClientTest]]", TypeHelper.GetTypeName(groupDictionary2), "ToDictionary(keySelector, elementSelector, IEqualityComparer) conversion for <string, Group> - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.Dictionary$2[[String],[Bridge.ClientTest.Utilities.Group, Bridge.ClientTest]]", TypeHelper.GetTypeName(groupDictionary3), "ToDictionary(keySelector) conversion for <string, Group> - check type name");
