...
namespace Bridge.ClientTest.Linq
{
    ...
    public class TestLinqConversionOperators
    {
        ...
        public static void Test()
        {
            ...
            Assert.AreEqual("System.Collections.Generic.List$1[[String]]", wordList1.GetType().FullName, "ToList() conversion with explicit String type for string - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.List$1[[String]]", wordList2.GetType().FullName, "ToList() conversion for string - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.Dictionary$2[[String],[Bridge.ClientTest.Utilities.Group, Bridge.ClientTest]]", groupDictionary1.GetType().FullName, "ToDictionary(keySelector, elementSelector) conversion for <string, Group> - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.Dictionary$2[[String],[Bridge.ClientTest.Utilities.Group, Bridge.ClientTest]]", groupDictionary2.GetType().FullName, "ToDictionary(keySelector, elementSelector, IEqualityComparer) conversion for <string, Group> - check type name");
            ...
            Assert.AreEqual("System.Collections.Generic.Dictionary$2[[String],[Bridge.ClientTest.Utilities.Group, Bridge.ClientTest]]", groupDictionary3.GetType().FullName, "ToDictionary(keySelector) conversion for <string, Group> - check type name");
