...
namespace Bridge.ClientTest.BridgeIssues
{
    ...
    public class Bridge1438
    {
        ...
        public static void TestJSONParse()
        {
            ...
            Assert.AreEqual("Bridge.ClientTest.BridgeIssues.Bridge1438.Foo", result.GetClassName(), "Check result type name");
        ...
        public static void TestJSONParseAsArray()
        {
            ...
            Assert.AreEqual("Bridge.ClientTest.BridgeIssues.Bridge1438.Foo", result[0].GetClassName(), "Check result[0] type name");
