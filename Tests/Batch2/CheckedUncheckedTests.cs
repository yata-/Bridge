    ...
    public class CheckedUncheckedTests
    {
        ...
        public class WithNoUncheckedKeywordTests
        {
            ...
            public static void TestInt32()
            {
                ...
                var min = Int32.MinValue;
                var rMin = min - 1;
                AssertEqual("-2147483649", rMin, "Through identifier");
                AssertEqual("-2147483649", min - 1, "Through parameter");
            }
            ...
            public static void TestUInt32()
            {
                var max = UInt32.MaxValue;
                var rMax = max + 1;
                AssertEqual("4294967296", rMax, "Through identifier");
                AssertEqual("4294967296", max + 1, "Through parameter");

                var min = UInt32.MinValue;
                var rMin = min - 1;
                AssertEqual("-1", rMin, "Through identifier");
                AssertEqual("-1", min - 1, "Through parameter");
            }
