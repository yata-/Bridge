...
Bridge.define('ClientTestLibrary.TestVersion', {
    statics: {
        testConstructors: function (assert) {
            ...
            assert.ok(System.Version.op_Inequality(v1, null), "v1 created");
            ...
            assert.ok(System.Version.op_Inequality(v2, null), "v2 created");
            ...
            assert.ok(System.Version.op_Inequality(v3, null), "v3 created");
            ...
            assert.ok(System.Version.op_Inequality(v4, null), "v4 created");
            ...
            assert.ok(System.Version.op_Inequality(v5, null), "v5 created");
            ...
            assert.ok(System.Version.op_Inequality(v6, null), "v6 created");
        ...
        testCloneCompare: function (assert) {
            ...
            assert.ok(System.Version.op_Inequality(v2, null), "v1 Cloned as Version");
        ...
        testParse: function (assert) {
            ...
            assert.equal(System.Version.parse(s1).toString(), v1.toString(), "Version.Parse(s1)");

            var s2 = "105.1";
            var v2 = new System.Version("constructor$4", s2);

            assert.equal(System.Version.parse(s2).toString(), v2.toString(), "Version.Parse(s2)");
        ...
        testOperators: function (assert) {
            ...
            assert.ok(System.Version.op_Equality(v1, v2), "v1 == v2");
            assert.notOk(System.Version.op_Inequality(v1, v2), "v1 != v2");
            assert.notOk(System.Version.op_GreaterThan(v1, v2), "v1 > v2");
            assert.ok(System.Version.op_GreaterThanOrEqual(v1, v2), "v1 >= v2");
            assert.notOk(System.Version.op_LessThan(v1, v2), "v1 < v2");
            assert.ok(System.Version.op_LessThanOrEqual(v1, v2), "v1 <= v2");

            assert.notOk(System.Version.op_Equality(v1, v3), "v1 == v3");
            assert.ok(System.Version.op_Inequality(v1, v3), "v1 != v3");
            assert.notOk(System.Version.op_GreaterThan(v1, v3), "v1 > v3");
            assert.notOk(System.Version.op_GreaterThanOrEqual(v1, v3), "v1 >= v3");
            assert.ok(System.Version.op_LessThan(v1, v3), "v1 < v3");
            assert.ok(System.Version.op_LessThanOrEqual(v1, v3), "v1 <= v3");

            assert.notOk(System.Version.op_Equality(v1, null), "v1 == null");
            assert.ok(System.Version.op_Inequality(v1, null), "v1 != null");
            assert.ok(System.Version.op_GreaterThan(v1, null), "v1 > null");
            assert.ok(System.Version.op_GreaterThanOrEqual(v1, null), "v1 >= null");
            assert.notOk(System.Version.op_LessThan(v1, null), "v1 < null");
            assert.notOk(System.Version.op_LessThanOrEqual(v1, null), "v1 <= null");

            assert.notOk(System.Version.op_Equality(null, v3), "null == v3");
            assert.ok(System.Version.op_Inequality(null, v3), "null != v3");
            assert.notOk(System.Version.op_GreaterThan(null, v3), "null > v3");
            assert.notOk(System.Version.op_GreaterThanOrEqual(null, v3), "null >= v3");
            assert.ok(System.Version.op_LessThan(null, v3), "null < v3");
            assert.ok(System.Version.op_LessThanOrEqual(null, v3), "null <= v3");

            var v4 = null;
            var v5 = null;

            assert.ok(System.Version.op_Equality(v4, v5), "v4 == v5");
            assert.notOk(System.Version.op_Inequality(v4, v5), "v4 != v5");
            assert.notOk(System.Version.op_GreaterThan(v4, v5), "v4 > v5");
            assert.notOk(System.Version.op_GreaterThanOrEqual(v4, v5), "v4 >= v5");
            assert.notOk(System.Version.op_LessThan(v4, v5), "v4 < v5");
            assert.notOk(System.Version.op_LessThanOrEqual(v4, v5), "v4 <= v5");
        }
    }
});
