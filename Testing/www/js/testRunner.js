...
Bridge.define('ClientTestLibrary.RunTests', {
    statics: {
        ...
        main: function () {
            ...
            Bridge.get(QUnit).test("#660", Bridge.get(ClientTestLibrary.Bridge660).testUseCase);
            ...
            Bridge.get(QUnit).test("#708", Bridge.get(ClientTestLibrary.Bridge708).testUseCase);
