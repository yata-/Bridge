...
return hash;}
if(typeof value=="object"){var result=0,temp;for(var property in value){if(value.hasOwnProperty(property)){temp=Bridge.isEmpty(value[property],true)?0:Bridge.getHashCode(value[property]);result=29*result+temp;}}
return result;}
...
if(typeof a=="object"&&typeof b=="object"){return Bridge.getHashCode(a)===Bridge.getHashCode(b);}
...
return strA.localeCompare(strB);}};Bridge.String=string;})();
