...
return scope;},ready:function(fn){var delayfn=function(){setTimeout(function(){fn();},1);};if(typeof Bridge.global.jQuery!=='undefined'){Bridge.global.jQuery(delayfn);}else{if(!document||document.readyState=="complete"||document.readyState=="loaded"){delayfn();}
...
var instanceConfig=prop.$config||prop.config;if(instanceConfig&&!Bridge.isFunction(instanceConfig)){Bridge.Class.initConfig(extend,base,instanceConfig,false,prop);if(document&&(document.readyState=="complete"||document.readyState=="loaded")){Bridge.Class.createAccessors(instanceConfig,prototype);}
...
if(Class.constructor){Class.constructor.call(Class);}};if(document&&(document.readyState=="complete"||document.readyState=="loaded")){fn();}
