...
return null;},getTypeName:function(obj){if(obj.$$name){return obj.$$name;}
var results=(/function (.{1,})\(/).exec((obj).constructor.toString());return(results&&results.length>1)?results[1]:"Object";},is:function(obj,type,ignoreFn){if(typeof type=="string"){type=Bridge.unroll(type);}
