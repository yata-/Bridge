...
(function(){var decimal={ceil:function(a){a=Bridge.Decimal.$(a);return Bridge.Decimal.$.round(a,0,a.is_minus?-1:-2);},floor:function(a){a=Bridge.Decimal.$(a);return Bridge.Decimal.$.round(a,0,a.is_minus?-2:-1);},round:function(a,digits,mode){if(!Bridge.hasValue(digits)){digits=0;}
...
return null;},div:function(a,b){if(Bridge.hasValue(a)&&Bridge.hasValue(b)){return Bridge.Decimal.$(a).div(b);}
return null;},eq:function(a,b){if(!Bridge.hasValue(a)){return!Bridge.hasValue(b);}
return Bridge.Decimal.$(a).compare(b)===0;},gt:function(a,b){if(!Bridge.hasValue(a)){return!Bridge.hasValue(b);}
return Bridge.Decimal.$(a).compare(b)===1;},gte:function(a,b){if(!Bridge.hasValue(a)){return!Bridge.hasValue(b);}
return Bridge.Decimal.$(a).compare(b)>=0;},neq:function(a,b){return!Bridge.Decimal.eq(a,b);},lt:function(a,b){if(!Bridge.hasValue(a)){return!Bridge.hasValue(b);}
return Bridge.Decimal.$(a).compare(b)===-1;},lte:function(a,b){if(!Bridge.hasValue(a)){return!Bridge.hasValue(b);}
return Bridge.Decimal.$(a).compare(b)<=0;},mod:function(a,b){if(Bridge.hasValue(a)&&Bridge.hasValue(b)){return Bridge.Decimal.$(a).mod(b);}
return null;},mul:function(a,b){if(Bridge.hasValue(a)&&Bridge.hasValue(b)){return Bridge.Decimal.$(a).mul(b);}
return null;},sub:function(a,b){if(Bridge.hasValue(a)&&Bridge.hasValue(b)){return Bridge.Decimal.$(a).sub(b);}
return null;},dec:function(a){if(Bridge.hasValue(a)){return Bridge.Decimal.$(a).sub(1);}
return null;},inc:function(a){if(Bridge.hasValue(a)){return Bridge.Decimal.$(a).add(1);}
return null;},neg:function(a){if(Bridge.hasValue(a)){return Bridge.Decimal.$(a).neg();}
return null;},pos:function(a){if(Bridge.hasValue(a)){return Bridge.Decimal.$(a);}
return null;},abs:function(a){if(Bridge.hasValue(a)){return Bridge.Decimal.$(a).abs();}
return null;},min:function(a,b){if(Bridge.hasValue(a)&&Bridge.hasValue(b)){a=Bridge.Decimal.$(a);b=Bridge.Decimal.$(b);return a.compareTo(b)<0?a:b;}
return null;},max:function(a,b){if(Bridge.hasValue(a)&&Bridge.hasValue(b)){a=Bridge.Decimal.$(a);b=Bridge.Decimal.$(b);return a.compareTo(b)>0?a:b;}
return null;}};Bridge.Decimal=decimal;})();(function(){var ROOT=this;var Decimal=function(v){if(this.constructor!=Decimal){return new Decimal(v);}
...
var last_num=obj.sig[last_word_pos]%tmp2;if(last_num>tmp2/2){round_up=true;}else if(last_num==tmp2/2){if(!zero_flag||!(last_digit_is_even&&mode==Decimal.MidpointRounding.ToEven)){round_up=true;}}
