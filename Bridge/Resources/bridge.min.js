...
return scope;},ready:function(fn){if(typeof Bridge.global.jQuery!=='undefined'){Bridge.global.jQuery(fn);}else{if(document.readyState=="complete"||document.readyState=="loaded"){fn();}
