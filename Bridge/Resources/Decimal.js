...
// mode: Decimal.MidpointRounding.AwayFromZero or
//       Decimal.MidpointRounding.ToEven
//
// Examples:
//
...
(function () {
    ...
    var Decimal = function (v, provider) {
        ...
        if (v_str.length - exp > Decimal.decimal_digits) {
    ...
    Decimal.lift = function(d) {
        return d == null ? null : Decimal(d);
    };
    ...
    Decimal.prototype.toString = function (format, provider) {
        if (!format && !provider) {
            if (this.isZero()) {
                return "0";
            }
    ...
    Decimal.prototype.format = function(fmt, provider) {
    ...
    Decimal.prototype.floor = function () {
        return Decimal.roundInternal(this, 0, this.is_minus ?
                                     Decimal.MidpointRounding.Ceil :
                                     Decimal.MidpointRounding.Floor);
    };
    ...
    Decimal.prototype.trunc = function () {
        return Decimal.roundInternal(this, 0, Decimal.MidpointRounding.Floor);
    };

    Decimal.round = function (obj, digits, mode) {
        if (mode != Decimal.MidpointRounding.AwayFromZero &&
            mode != Decimal.MidpointRounding.ToEven) {
            throw new Bridge.ArgumentException("mode");
        }
        return Decimal.roundInternal(obj, digits, mode);
    }

    Decimal.roundInternal = function (obj, digits, mode) {
        ...
        if (mode == Decimal.MidpointRounding.Floor) {
            ;  // round_up remains false
        } else if (mode == Decimal.MidpointRounding.Ceil &&
            !(last_num == 0 && zero_flag)) {
            round_up = true;
        } else {
            var last_digit_is_even = (Math.floor(obj.sig[round_word_pos] / tmp)
                                      % 2 == 0);
    ...
    Decimal.prototype.compareTo = function (another) {
    ...
    Decimal.prototype.mod = function (other) {
        var other_decimal = (other instanceof Decimal ? other :
                             new Decimal(other));
        var a = this.abs();
        var b = other_decimal.abs();
        var r = a.sub(a.div(b).trunc().mul(b));
    ...
    Decimal.prototype.neg = function () {
        var r = new Decimal(this);
        if (!r.isZero()) {
            r.is_minus = !r.is_minus;
        }
        return r;
    };

    Decimal.prototype.inc = function() {
        return this.addSub(1, false);
    };

    Decimal.prototype.dec = function() {
    ...
    Decimal.prototype.ne = function(v) {
        return !!this.compareTo(v);
    };

    Decimal.prototype.lt = function(v) {
        return this.compareTo(v) < 0;
    };

    Decimal.prototype.lte = function(v) {
        return this.compareTo(v) <= 0;
    };

    Decimal.prototype.gt = function(v) {
        return this.compareTo(v) > 0;
    };

    Decimal.prototype.gte = function(v) {
        return this.compareTo(v) >= 0;
    };

    Decimal.prototype.equals = function(v) {
        return !this.compareTo(v);
    };

    Decimal.prototype.equalsT = function(v) {
        return !this.compareTo(v);
    };
    ...
    Decimal.max = function (a, b) {
        return a.compareTo(b) > 0 ? a : b;
    };

    Decimal.tryParse = function(s, provider, v) {
        try {
