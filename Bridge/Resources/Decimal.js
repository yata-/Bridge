...
(function () {
    ...
    Bridge.Decimal.prototype.getHashCode = function () {
        var n = (this.value.s * 397 + this.value.e) | 0;
    ...
    Bridge.Decimal.min = function (a, b) {
        return Decimal.min(Bridge.Decimal.getValue(a), Bridge.Decimal.getValue(b));
    };

    Bridge.Decimal.max = function (a, b) {
        return Decimal.max(Bridge.Decimal.getValue(a), Bridge.Decimal.getValue(b));
    };
