...
namespace System.Linq.Expressions
{
    ...
    public abstract class Expression
    {
        ...
        [Template("{ ntype: 46, type: {right}.type, left: {left}, right: {right} }")]
        ...
        [Template("{ ntype: 13, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression Equal(Expression left, Expression right, Type type);

        [Template("{ ntype: 13, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 35, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression NotEqual(Expression left, Expression right, Type type);

        [Template("{ ntype: 35, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 15, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression GreaterThan(Expression left, Expression right, Type type);

        [Template("{ ntype: 15, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 20, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression LessThan(Expression left, Expression right, Type type);

        [Template("{ ntype: 20, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 16, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression GreaterThanOrEqual(Expression left, Expression right, Type type);

        [Template("{ ntype: 16, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 21, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression LessThanOrEqual(Expression left, Expression right, Type type);

        [Template("{ ntype: 21, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 3, type: {type}, left: {left}, right: {right} }")]
        ...
        [Template("{ ntype: 37, type: {type}, left: {left}, right: {right} }")]
        ...
        [Template("{ ntype: 7, type: {type}, left: {left}, right: {right} }")]
        ...
        [Template("{ ntype: 74, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression AddAssignChecked(Expression left, Expression right, Type type);

        [Template("{ ntype: 74, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 1, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression AddChecked(Expression left, Expression right, Type type);

        [Template("{ ntype: 1, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 76, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression SubtractAssignChecked(Expression left, Expression right, Type type);

        [Template("{ ntype: 76, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 43, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression SubtractChecked(Expression left, Expression right, Type type);

        [Template("{ ntype: 43, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 75, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression MultiplyAssignChecked(Expression left, Expression right, Type type);

        [Template("{ ntype: 75, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 27, type: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression MultiplyChecked(Expression left, Expression right, Type type);

        [Template("{ ntype: 27, type: {method}.returnType, left: {left}, right: {right}, method: {method} }")]
        ...
        [Template("{ ntype: 5, type: {type}, left: {array}, right: {index} }")]
        ...
        [Template("{ ntype: 6, type: {type}, obj: {array}, method: { type: 8, typeDef: Array, name: 'Get', returnType: {type}, params: System.Array.init({indexes:array}.length, System.Int32, true), def: function() { return System.Array.$get.call(this, arguments); } }, args: Bridge.toList({indexes:array}) }")]
        public static extern MethodCallExpression ArrayIndex(Type type, Expression array, params Expression[] indexes);

        [Template("(function(a, b, c) { return { ntype: 6, type: a, obj: b, method: { type: 8, typeDef: Array, name: 'Get', returnType: a, params: System.Array.init(c.getCount(), System.Int32, true), def: function() { return System.Array.$get.call(this, arguments); } }, args: c }; })({type}, {array}, Bridge.toList({indexes}))")]
        public static extern MethodCallExpression ArrayIndex(Type type, Expression array, IEnumerable<Expression> indexes);

        [Template("{ ntype: 47, type: {expressions:array}[{expressions:array}.length - 1].type, expressions: Bridge.toList({expressions:array}) }")]
        public static extern BlockExpression Block(params Expression[] expressions);

        [Template("(function(a) { return { ntype: 47, type: a.get(a.getCount() - 1).type, expressions: a }; })(Bridge.toList({expressions}))")]
        public static extern BlockExpression Block(IEnumerable<Expression> expressions);

        [Template("{ ntype: 47, type: {type}, expressions: Bridge.toList({expressions:array}) }")]
        public static extern BlockExpression Block(Type type, params Expression[] expressions);

        [Template("{ ntype: 47, type: {type}, expressions: Bridge.toList({expressions}) }")]
        public static extern BlockExpression Block(Type type, IEnumerable<Expression> expressions);

        [Template("{ ntype: 47, type: {expressions:array}[{expressions:array}.length - 1].type, variables: Bridge.toList({variables}), expressions: Bridge.toList({expressions:array}) }")]
        public static extern BlockExpression Block(IEnumerable<ParameterExpression> variables, params Expression[] expressions);

        [Template("(function(a, b) { return { ntype: 47, type: b.get(b.getCount() - 1).type, variables: a, expressions: b }; })(Bridge.toList({variables}), Bridge.toList({expressions}))")]
        public static extern BlockExpression Block(IEnumerable<ParameterExpression> variables, IEnumerable<Expression> expressions);

        [Template("{ ntype: 47, type: {type}, variables: Bridge.toList({variables}), expressions: Bridge.toList({expressions:array}) }")]
        ...
        [Template("{ ntype: 47, type: {type}, variables: Bridge.toList({variables}), expressions: Bridge.toList({expressions}) }")]
        ...
        [Template("{ test: {variable}.type, variable: {variable}, body: {body} }")]
        ...
        [Template("{ test: {variable}.type, variable: {variable}, body: {body}, filter: {filter} }")]
        public static extern CatchBlock Catch(ParameterExpression variable, Expression body, Expression filter);

        [Template("{ test: {type} || {variable}.type, variable: {variable}, body: {body}, filter: {filter} }")]
        ...
        [Template("{ ntype: 8, type: {type}, test: {test}, ifTrue: {ifTrue}, ifFalse: {ifFalse} }")]
        public static extern ConditionalExpression Condition(Expression test, Expression ifTrue, Expression ifFalse, Type type);

        [Template("{ ntype: 8, type: Object, test: {test}, ifTrue: {ifTrue}, ifFalse: { ntype: 51, type: Object } }")]
        public static extern ConditionalExpression IfThen(Expression test, Expression ifTrue);

        [Template("{ ntype: 8, type: Object, test: {test}, ifTrue: {ifTrue}, ifFalse: {ifFalse} }")]
        ...
        [Template("{ ntype: 50, type: Object, dtype: 0, expression: {expression}, member: {member} }")]
        public static extern DynamicMemberExpression DynamicMember(Expression expression, string member);

        [Template("{ ntype: 50, type: {type}, dtype: 0, expression: {expression}, member: {member} }")]
        public static extern DynamicMemberExpression DynamicMember(Type type, Expression expression, string member);

        [Template("{ ntype: 50, type: Object, dtype: 1, expression: {expression}, arguments: Bridge.toList({arguments:array}) }")]
        public static extern DynamicInvocationExpression DynamicInvocation(Expression expression, params Expression[] arguments);

        [Template("{ ntype: 50, type: Object, dtype: 1, expression: {expression}, arguments: Bridge.toList({arguments}) }")]
        ...
        [Template("{ ntype: 50, type: {type}, dtype: 1, expression: {expression}, arguments: Bridge.toList({arguments:array}) }")]
        ...
        [Template("{ ntype: 50, type: {type}, dtype: 1, expression: {expression}, arguments: Bridge.toList({arguments}) }")]
        ...
        [Template("{ ntype: 50, type: Object, dtype: 2, expression: {expression}, argument: {argument} }")]
        public static extern DynamicIndexExpression DynamicIndex(Expression expression, Expression argument);

        [Template("{ ntype: 50, type: {type}, dtype: 2, expression: {expression}, argument: {argument} }")]
        ...
        [Template("{ ntype: 55, type: {type}, obj: {array}, arguments: Bridge.toList({indexes:array}) }")]
        public static extern IndexExpression ArrayAccess(Type type, Expression array, params Expression[] indexes);

        [Template("{ ntype: 55, type: {type}, obj: {array}, arguments: Bridge.toList({indexes}) }")]
        ...
        [Template("{ ntype: 55, type: {indexer}.returnType, obj: {instance}, indexer: {indexer}, arguments: Bridge.toList({arguments:array}) }")]
        public static extern IndexExpression Property(Expression instance, PropertyInfo indexer, params Expression[] arguments);

        [Template("{ ntype: 55, type: {indexer}.returnType, obj: {instance}, indexer: {indexer}, arguments: Bridge.toList({arguments}) }")]
        ...
        [Template("{ ntype: 17, type: {type}, expression: {expression}, args: Bridge.toList({arguments:array}) }")]
        public static extern InvocationExpression Invoke(Type type, Expression expression, params Expression[] arguments);

        [Template("{ ntype: 17, type: {type}, expression: {expression}, args: Bridge.toList({arguments}) }")]
        public static extern InvocationExpression Invoke(Type type, Expression expression, IEnumerable<Expression> arguments);

        [Template("{ ntype: 56, type: {target}.type, target: {target} }")]
        public static extern LabelExpression Label(LabelTarget target);

        [Template("{ ntype: 56, type: {target}.type, target: {target}, defaultValue: {defaultValue} }")]
        ...
        [Template("{ type: Object, name: {name} }")]
        ...
        [Template("{ ntype: 18, type: Function, returnType: {body}.type, body: {body}, params: Bridge.toList({parameters}) }")]
        public static extern Expression<TDelegate> Lambda<TDelegate>(Expression body, IEnumerable<ParameterExpression> parameters);

        [Template("{ ntype: 18, type: Function, returnType: {body}.type, body: {body}, params: Bridge.toList({parameters:array}) }")]
        ...
        [Template("{ ntype: 22, type: {newExpression}.type, newExpression: {newExpression}, initializers: Bridge.toList({initializers:array}.map(function(i) { return { addMethod: {addMethod}, arguments: Bridge.toList([i]) }; })) }")]
        ...
        [Template("{ ntype: 22, type: {newExpression}.type, newExpression: {newExpression}, initializers: Bridge.toList(Bridge.toArray({initializers}).map(function(i) { return { addMethod: {addMethod}, arguments: Bridge.toList([i]) }; })) }")]
        ...
        [Template("{ ntype: 22, type: {newExpression}.type, newExpression: {newExpression}, initializers: Bridge.toList({initializers:array}) }")]
        public static extern ListInitExpression ListInit(NewExpression newExpression, params ElementInit[] initializers);

        [Template("{ ntype: 22, type: {newExpression}.type, newExpression: {newExpression}, initializers: Bridge.toList({initializers}) }")]
        public static extern ListInitExpression ListInit(NewExpression newExpression, IEnumerable<ElementInit> initializers);

        [Template("{ ntype: 58, type: Object, body: {body} }")]
        public static extern LoopExpression Loop(Expression body);

        [Template("{ ntype: 58, type: {break}.type, body: {body}, breakLabel: {break} }")]
        public static extern LoopExpression Loop(Expression body, LabelTarget @break);

        [Template("{ ntype: 58, type: {break} ? {break}.type : Object, body: {body}, breakLabel: {break}, continueLabel: {continue} }")]
        ...
        [Template("{ ntype: 23, type: {field}.returnType, expression: {expression}, member: {field} }")]
        public static extern MemberExpression Field(Expression expression, FieldInfo field);

        [Template("{ ntype: 23, type: Bridge.Reflection.getMembers({expression}.type, 4, 284, {fieldName}).returnType, expression: {expression}, member: Bridge.Reflection.getMembers({expression}.type, 4, 284, {fieldName}) }")]
        public static extern MemberExpression Field(Expression expression, string fieldName);

        [Template("{ ntype: 23, type: {type}, expression: {expression}, member: Bridge.Reflection.getMembers({expression}.type, 4, 284, {fieldName}) }")]
        public static extern MemberExpression Field(Expression expression, Type type, string fieldName);

        [Template("{ ntype: 23, type: Bridge.Reflection.getMembers({expression}.type, 16, 284, {propertyName}).returnType, expression: {expression}, member: Bridge.Reflection.getMembers({expression}.type, 16, 284, {propertyName}) }")]
        public static extern MemberExpression Property(Expression expression, string propertyName);

        [Template("{ ntype: 23, type: {type}, expression: {expression}, member: Bridge.Reflection.getMembers({expression}.type, 16, 284, {propertyName}) }")]
        public static extern MemberExpression Property(Expression expression, Type type, string propertyName);

        [Template("{ ntype: 23, type: {property}.returnType, expression: {expression}, member: {property} }")]
        ...
        [Template("{ ntype: 23, type: Bridge.Reflection.getMembers({expression}.type, 20, 284, {propertyOrFieldName}).returnType, expression: {expression}, member: Bridge.Reflection.getMembers({expression}.type, 20, 284, {propertyOrFieldName}) }")]
        public static extern MemberExpression PropertyOrField(Expression expression, string propertyOrFieldName);

        [Template("{ ntype: 23, type: {member}.returnType, expression: {expression}, member: {member} }")]
        public static extern MemberExpression MakeMemberAccess(Expression expression, MemberInfo member);

        [Template("{ ntype: 24, type: {newExpression}.type, newExpression: {newExpression}, bindings: Bridge.toList({bindings:array}) }")]
        public static extern MemberInitExpression MemberInit(NewExpression newExpression, params MemberBinding[] bindings);

        [Template("{ ntype: 24, type: {newExpression}.type, newExpression: {newExpression}, bindings: Bridge.toList({bindings}) }")]
        ...
        [Template("{ ntype: 6, type: {method}.returnType, method: {method}, args: Bridge.toList({arguments:array}) }")]
        public static extern MethodCallExpression Call(MethodInfo method, params Expression[] arguments);

        [Template("{ ntype: 6, type: {method}.returnType, method: {method}, args: Bridge.toList({arguments}) }")]
        public static extern MethodCallExpression Call(MethodInfo method, IEnumerable<Expression> arguments);

        [Template("{ ntype: 6, type: {method}.returnType, obj: {instance}, method: {method}, args: Bridge.toList({arguments:array}) }")]
        public static extern MethodCallExpression Call(Expression instance, MethodInfo method, params Expression[] arguments);

        [Template("{ ntype: 6, type: {method}.returnType, obj: {instance}, method: {method}, args: Bridge.toList({arguments}) }")]
        public static extern MethodCallExpression Call(Expression instance, MethodInfo method, IEnumerable<Expression> arguments);

        [Template("{ ntype: 32, type: Array, expressions: Bridge.toList({initializers:array}) }")]
        public static extern NewArrayExpression NewArrayInit(Type type, params Expression[] initializers);

        [Template("{ ntype: 32, type: Array, expressions: Bridge.toList({initializers}) }")]
        public static extern NewArrayExpression NewArrayInit(Type type, IEnumerable<Expression> initializers);

        [Template("{ ntype: 33, type: Array, expressions: Bridge.toList({bounds:array}) }")]
        public static extern NewArrayExpression NewArrayBounds(Type type, params Expression[] bounds);

        [Template("{ ntype: 33, type: Array, expressions: Bridge.toList({bounds}) }")]
        public static extern NewArrayExpression NewArrayBounds(Type type, IEnumerable<Expression> bounds);

        [Template("{ ntype: 31, type: {type}, constructor: Bridge.Reflection.getMembers({type}, 1, 284, null, []), arguments: Bridge.toList([]) }")]
        public static extern NewExpression New(Type type);

        [Template("{ ntype: 31, type: {constructor}.typeDef, constructor: {constructor}, arguments: Bridge.toList({arguments:array}) }")]
        public static extern NewExpression New(ConstructorInfo constructor, params Expression[] arguments);

        [Template("{ ntype: 31, type: {constructor}.typeDef, constructor: {constructor}, arguments: Bridge.toList({arguments}) }")]
        public static extern NewExpression New(ConstructorInfo constructor, IEnumerable<Expression> arguments);

        [Template("{ ntype: 31, type: {constructor}.typeDef, constructor: {constructor}, arguments: Bridge.toList({arguments}), members: Bridge.toList({members:array}) }")]
        public static extern NewExpression New(ConstructorInfo constructor, Expression[] arguments, params MemberInfo[] members);

        [Template("{ ntype: 31, type: {constructor}.typeDef, constructor: {constructor}, arguments: Bridge.toList({arguments}), members: Bridge.toList({members}) }")]
        ...
        [Template("{ ntype: 38, type: {type} }")]
        public static extern ParameterExpression Parameter(Type type);

        [Template("{ ntype: 38, type: {type}, name: {name} }")]
        ...
        [Template("{ ntype: 59, type: {cases:array}[0].body.type, switchValue: {switchValue}, cases: Bridge.toList({cases:array}) }")]
        public static extern SwitchExpression Switch(Expression switchValue, params SwitchCase[] cases);

        [Template("{ ntype: 59, type: {cases:array}[0].body.type, switchValue: {switchValue}, defaultBody: {defaultBody}, cases: Bridge.toList({cases:array}) }")]
        public static extern SwitchExpression Switch(Expression switchValue, Expression defaultBody, params SwitchCase[] cases);

        [Template("{ ntype: 59, type: {cases:array}[0].body.type, switchValue: {switchValue}, defaultBody: {defaultBody}, comparison: {comparison}, cases: Bridge.toList({cases:array}) }")]
        ...
        [Template("{ ntype: 59, type: {type}, switchValue: {switchValue}, defaultBody: {defaultBody}, comparison: {comparison}, cases: Bridge.toList({cases:array}) }")]
        ...
        [Template("(function(a, b, c, d) { return { ntype: 59, type: d.get(0).body.type, switchValue: a, defaultBody: b, comparison: c, cases: d }; })({switchValue}, {defaultBody}, {comparison}, Bridge.toList({cases}))")]
        ...
        [Template("{ ntype: 59, type: {type}, switchValue: {switchValue}, defaultBody: {defaultBody}, comparison: {comparison}, cases: Bridge.toList({cases}) }")]
        ...
        [Template("{ ntype: 61, type: {body}.type, body: {body}, handlers: Bridge.toList([]), fault: {fault} }")]
        public static extern TryExpression TryFault(Expression body, Expression fault);

        [Template("{ ntype: 61, type: {body}.type, body: {body}, handlers: Bridge.toList([]), finallyExpr: {finally} }")]
        public static extern TryExpression TryFinally(Expression body, Expression @finally);

        [Template("{ ntype: 61, type: {body}.type, body: {body}, handlers: Bridge.toList({handlers:array}) }")]
        public static extern TryExpression TryCatch(Expression body, params CatchBlock[] handlers);

        [Template("{ ntype: 61, type: {body}.type, body: {body}, finallyExpr: {finally}, handlers: Bridge.toList({handlers:array}) }")]
        public static extern TryExpression TryCatchFinally(Expression body, Expression @finally, params CatchBlock[] handlers);

        [Template("{ ntype: 61, type: {type} || {body}.type, body: {body}, finallyExpr: {finally}, fault: {fault}, handlers: Bridge.toList({handlers} || []) }")]
        ...
        [Template("{ ntype: 45, type: Boolean, expression: {expression}, typeOperand: {type} }")]
        public static extern TypeBinaryExpression TypeIs(Expression expression, Type type);

        [Template("{ ntype: 81, type: Boolean, expression: {expression}, typeOperand: {type} }")]
        public static extern TypeBinaryExpression TypeEqual(Expression expression, Type type);

        [Template("{ ntype: {unaryType}, type: {type}, operand: {operand} }")]
        public static extern UnaryExpression MakeUnary(ExpressionType unaryType, Expression operand, Type type);

        [Template("{ ntype: {unaryType}, type: {type} || {method}.returnType, operand: {operand}, method: {method} }")]
        ...
        [Template("{ ntype: 28, type: {type}, operand: {expression} }")]
        public static extern UnaryExpression Negate(Expression expression, Type type);

        [Template("{ ntype: 28, type: {method}.returnType, operand: {expression}, method: {method} }")]
        ...
        [Template("{ ntype: 29, type: {type}, operand: {expression} }")]
        public static extern UnaryExpression UnaryPlus(Expression expression, Type type);

        [Template("{ ntype: 29, type: {method}.returnType, operand: {expression}, method: {method} }")]
        ...
        [Template("{ ntype: 30, type: {type}, operand: {expression} }")]
        public static extern UnaryExpression NegateChecked(Expression expression, Type type);

        [Template("{ ntype: 30, type: {method}.returnType, operand: {expression}, method: {method} }")]
