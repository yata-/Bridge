...
namespace System
{
    ...
    public sealed partial class Console
    {
        ...
        [Template("Bridge.Console.log(Bridge.String.format({format}, {arg0}))")]
        ...
        [Template("Bridge.Console.log(Bridge.String.format({format}, {arg0}, {arg1}))")]
        ...
        [Template("Bridge.Console.log(Bridge.String.format({format}, {arg0}, {arg1}, {arg2}))")]
        ...
        [Template("Bridge.Console.log(Bridge.String.format({format}, {arg0}, {arg1}, {arg2}, {arg3}))")]
        ...
        [Template("Bridge.Console.log(Bridge.String.format({format}, {arg}))")]
        ...
        /// </summary>
        /// <param name="value">The value to write.</param>
        [Template("Bridge.Console.log(Bridge.Enum.toString({value:type}, {value}))")]
